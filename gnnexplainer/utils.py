...
def fidelity(model, target_node, feature, edge, explaine_edge, label, ppi=None):
    ...
    with torch.no_grad():
        ...
        device = torch.device(feature.device) if torch.cuda.is_available() else torch.device('cpu')
