...
for node in range(0, data.x.shape[0], 5):
    ...
    if predict[node] != data.label[node] or not(label[node] in label_list):
        continue
...
#        print(motif_edge)
        ...
        #     edge_weight[e_idx] = 1
        #print(model_encoder(feature_zero_node.to(device), torch.LongTensor(motif_edge+motif_edge_path).T.to(device)))
        ...
        #     exit()
        # print(len(node_motifs.keys()))
        # print(len(motif_embedding))
    #fid = fidelity(model, node, feature, data.edge_index, [(302, 303), (303, 302), (301, 302), (302,301), (304,301 ), (301, 304), (300, 304), (300,301),(300, 303), (303, 300), (301,300), (304,300)], data.label, ppi=None)
    #print(fid)
