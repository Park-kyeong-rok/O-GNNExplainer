...
parser.add_argument('--data', type=str ,default='ppi_mini',
                    help='Interested Data')
parser.add_argument('--thr', type=float, default=  0.5128764,
...
parser.add_argument('--model_name', type=str, default='ppi_mini_model',
...
parser.add_argument('--OHEM_loss', action='store_true', default=False,
                    help='Do you want to train the orbit weight?')
parser.add_argument('--b_lr', type=float, default=0.001,
                    help='Binary classifier learning rate')
parser.add_argument('--b_batch', type=int, default=256,
                    help='Bainary classifier batch')
parser.add_argument('--b_epoch', type=int, default=3000,
...
parser.add_argument('--score_learning', action='store_true', default=True,
